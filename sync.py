...
#delete stg record
print 'Step 1: delete stg record'
...
#import data to stg
print 'Step 2: import data to stg'
for item in items:
	g = geocoder.google(item['location'])
	#print item['location'],g.latlng
...
print 'Step 3: delete target record'
...
print 'Step 4: import data to target'
